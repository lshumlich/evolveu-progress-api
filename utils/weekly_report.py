...
def create_weekly_report(start_date, report_date):
	...
	wr.week_number = course_mondays[report_date]

	wr.results = sql.sql.get_prev_results_obj(level=wr.week_number, date=report_date, order="date, name")
